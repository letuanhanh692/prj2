...
<head>
    <base href="/">
    <link rel="shortcut icon" type="image" href="front/img/logo/logo4.png">
    <meta charset="utf-8">
    ...
    <div class="app-container app-theme-white body-tabs-shadow fixed-header fixed-sidebar">
        <div class="app-header header-shadow">
            <div class="app-header__logo">
                <div class="logo-src" style="background-image: url('dashboard/assets/images/avatars/logo2.PNG')">
                                ...
                                <li class="list-group-item">
                                    ...
                                    <div class="theme-settings-swatches">
                                        <div role="group" class="mt-2 btn-group">
                                            <button type="button"
                                                class="btn-wide btn-shadow btn-success btn btn-secondary switch-theme-class"
                                                data-class="body-tabs-line"> Line</button>
                                            <button type="button"
                                                class="btn-wide btn-shadow btn-success active btn btn-secondary switch-theme-class"
